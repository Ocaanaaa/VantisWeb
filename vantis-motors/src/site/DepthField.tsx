...
/** Retícula de puntos en grafito que se inclina con el puntero. Da profundidad. */
export default function DepthField() {
  ...
  return <div ref={mount} aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 opacity-70 [&>canvas]:block [&>canvas]:h-full [&>canvas]:w-full" />;
}
